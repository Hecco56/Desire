...
public class ModRecipeProvider extends FabricRecipeProvider {
    ...
    public void generate(RecipeExporter exporter) {
        ...
        ShapelessRecipeJsonBuilder.create(RecipeCategory.BUILDING_BLOCKS, BlockSetGenerator.BLOCK_SET_BLOCKS.get("basalt_tiles"), 4).input(Blocks.POLISHED_BASALT).input(Blocks.POLISHED_BLACKSTONE).criterion("has_stone", conditionsFromItem(Blocks.POLISHED_BASALT)).offerTo(exporter);
        ...
        offer2x2ReversibleCompactingRecipes(exporter, RecipeCategory.MISC, BlockSetGenerator.BLOCK_SET_BLOCKS.get("flint_block"), RecipeCategory.BUILDING_BLOCKS, Items.FLINT);
