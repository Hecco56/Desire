...
public class ModModelProvider extends DesireModelProvider {
    ...
    public void generateBlockStateModels(BlockStateModelGenerator blockStateModelGenerator) {
        ...
        polishedWall(blockStateModelGenerator, BlockFamilyGenerator.BLOCKS.get("polished_andesite_wall"), Identifier.of(Desire.MOD_ID, "block/polished_andesite_wall_post"), Identifier.of(Desire.MOD_ID, "block/polished_andesite_wall_side"), Identifier.of("minecraft", "block/polished_andesite"));
        polishedWall(blockStateModelGenerator, BlockFamilyGenerator.BLOCKS.get("polished_granite_wall"), Identifier.of(Desire.MOD_ID, "block/polished_granite_wall_post"), Identifier.of(Desire.MOD_ID, "block/polished_granite_wall_side"), Identifier.of("minecraft", "block/polished_granite"));
        polishedWall(blockStateModelGenerator, BlockFamilyGenerator.BLOCKS.get("polished_diorite_wall"), Identifier.of(Desire.MOD_ID, "block/polished_diorite_wall_post"), Identifier.of(Desire.MOD_ID, "block/polished_diorite_wall_side"), Identifier.of("minecraft", "block/polished_diorite"));
