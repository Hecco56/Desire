    ...
    public static ItemGroup DESIRE = Registry.register(Registries.ITEM_GROUP, Identifier.of(Desire.MOD_ID, "desire"),
            FabricItemGroup.builder().displayName(Text.translatable("itemgroup.desire"))
                    .icon(() -> new ItemStack(ModItems.DESIRE_ICON)).entries((displayContext, entries) -> {
                        ...
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_stone_wall"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("stone_tiles"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cracked_stone_tiles"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("stone_tile_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("stone_tile_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("stone_tile_wall"));
                        entries.add(Blocks.SMOOTH_STONE);
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_stone_stairs"));
                        entries.add(Blocks.SMOOTH_STONE_SLAB);
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_stone_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_stone_brick_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_stone_brick_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_stone_brick_wall"));
                        ...
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cobblestone_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cobblestone_brick_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cobblestone_brick_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cobblestone_brick_wall"));
                        ...
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("mossy_cobblestone_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("mossy_cobblestone_brick_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("mossy_cobblestone_brick_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("mossy_cobblestone_brick_wall"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_granite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cracked_polished_granite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_granite_brick_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_granite_brick_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_granite_brick_wall"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_andesite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cracked_polished_andesite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_andesite_brick_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_andesite_brick_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_andesite_brick_wall"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_diorite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cracked_polished_diorite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_diorite_brick_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_diorite_brick_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_diorite_brick_wall"));
                        ...
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("calcite_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("calcite_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("calcite_wall"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("chiseled_calcite"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_calcite"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_calcite_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_calcite_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_calcite_wall"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("calcite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("calcite_brick_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("calcite_brick_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("calcite_brick_wall"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("cracked_calcite_bricks"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("chiseled_calcite_bricks"));
                        ...
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_basalt_stairs"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_basalt_slab"));
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("smooth_basalt_wall"));
                        ...
                        entries.add(BlockSetGenerator.BLOCK_SET_BLOCKS.get("polished_andesite_wall"));
